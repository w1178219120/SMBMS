...
function deleteProvider(obj){
	$.ajax({
		...
		data:{method:"delprovider",providerid:obj.attr("proid")},
		dataType:"json",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/provider/getpro?method=view&proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/update?method=modify&id="+ obj.attr("proid");
	});
