...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/login">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/login">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/show">用户管理</a></li>
